...
class RagPoisoningChallenge(BaseChallenge):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Per-instance deep copy: list copy + every dict copy.
        # super().__init__ already handles self.secrets + self.atlas_mapping
        # (P12-2 #1+#2 closure in BaseChallenge).
        self.knowledge_base = copy.deepcopy(self.__class__._DEFAULT_KNOWLEDGE_BASE)
