...
Long-form writeup withdrawn in an OPSEC pass and not rewritten; the solver is the published record. | [Solver Code](gandalf/gandalf_solver.py)
...
Long-form writeup withdrawn in an OPSEC pass and not rewritten; the solvers are the published record. | [Solver M1](agent-odin/solver.py) | [Solver M2](agent-odin/solver_m2.py) | [Solver M3](agent-odin/solver_m3.py)
